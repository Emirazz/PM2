package de.hawhh.informatik.sml.werkzeug.rueckgabe;
...
import de.hawhh.informatik.sml.verwalter.VerleihkartenTableModel;
...
class RueckgabeUI
{
    ...
    private void erzeugeVerleihkartenAnzeiger()
    {
        ...
        verleihkartenAnzeigerScrollPane.setBorder(BorderFactory
                .createTitledBorder(null, "Ausgew�hlte Verleihkarten",
                        TitledBorder.LEADING, TitledBorder.DEFAULT_POSITION,
                        UIConstants.HEADER_FONT));
    ...
    private void erzeugeRuecknahmeButton()
    {
        ...
        _ruecknahmeButton.setText("zur�cknehmen");
